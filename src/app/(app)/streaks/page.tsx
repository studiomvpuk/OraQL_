...
function shortMarketLabel(marketName: string, line: number | null): string {
  const labels: Record<string, string> = {
    GOALS_OVER: `MO${line}G`,
    GOALS_UNDER: `MU${line}G`,
    ...
    MATCH_RESULT_DRAW: 'Draw',
    MATCH_RESULT_AWAY: 'Lose',
    DOUBLE_CHANCE_WIN_OR_DRAW: 'W/D',
    DOUBLE_CHANCE_NO_DRAW: 'NoDraw',
    WIN_TO_NIL: 'WtN',
    TEAM_TO_SCORE_YES: 'Score',
    TEAM_TO_SCORE_NO: 'NoScore',
    TOTAL_GOALS_ODD: 'Odd',
    TOTAL_GOALS_EVEN: 'Even',
    EXACT_GOALS: `Exact${line}`,
    SHOTS_OVER: `O${line}Sh`,
    SHOTS_UNDER: `U${line}Sh`,
    SHOTS_ON_TARGET_OVER: `O${line}SoT`,
    SHOTS_ON_TARGET_UNDER: `U${line}SoT`,
    FOULS_OVER: `O${line}F`,
    FOULS_UNDER: `U${line}F`,
    OFFSIDES_OVER: `O${line}Off`,
    OFFSIDES_UNDER: `U${line}Off`,
  };
...
function marketGuide(name: string, line: number | null): string {
  const guides: Record<string, string> = {
    GOALS_OVER: `Both teams combined must score more than ${line} goals in the match`,
    GOALS_UNDER: `Both teams combined must score fewer than ${line} goals in the match`,
    TEAM_GOALS_OVER: `This specific team must score more than ${line} goals`,
    TEAM_GOALS_UNDER: `This specific team must score fewer than ${line} goals`,
    CORNERS_OVER: `Both teams combined must have more than ${line} corners`,
    CORNERS_UNDER: `Both teams combined must have fewer than ${line} corners`,
    CARDS_OVER: `Both teams combined must receive more than ${line} cards (yellow + red)`,
    CARDS_UNDER: `Both teams combined must receive fewer than ${line} cards`,
    BTTS_YES: 'Both teams must each score at least one goal',
    BTTS_NO: 'At least one team finishes with zero goals',
    CLEAN_SHEET: 'This team concedes zero goals — opponent does not score',
    MATCH_RESULT_HOME: 'This team wins the match',
    MATCH_RESULT_DRAW: 'The match ends in a draw — both teams score the same number of goals',
    MATCH_RESULT_AWAY: 'This team loses the match',
    DOUBLE_CHANCE_WIN_OR_DRAW: 'This team either wins or the match ends in a draw — they do not lose',
    DOUBLE_CHANCE_NO_DRAW: 'The match does not end in a draw — one team must win',
    WIN_TO_NIL: 'This team wins AND the opponent scores zero goals',
    TEAM_TO_SCORE_YES: 'This team scores at least one goal in the match',
    TEAM_TO_SCORE_NO: 'This team does not score — they finish with zero goals',
    TOTAL_GOALS_ODD: 'The total number of goals in the match is an odd number (1, 3, 5...)',
    TOTAL_GOALS_EVEN: 'The total number of goals in the match is an even number (0, 2, 4...)',
    EXACT_GOALS: line === 4 ? 'The match has exactly 4 or more total goals' : `The match has exactly ${line} total goals`,
    SHOTS_OVER: `This team must have more than ${line} total shots in the match`,
    SHOTS_UNDER: `This team must have fewer than ${line} total shots`,
    SHOTS_ON_TARGET_OVER: `This team must have more than ${line} shots on target`,
    SHOTS_ON_TARGET_UNDER: `This team must have fewer than ${line} shots on target`,
    FOULS_OVER: `Both teams combined must commit more than ${line} fouls`,
    FOULS_UNDER: `Both teams combined must commit fewer than ${line} fouls`,
    OFFSIDES_OVER: `This team must be caught offside more than ${line} times`,
    OFFSIDES_UNDER: `This team must be caught offside fewer than ${line} times`,
  };
